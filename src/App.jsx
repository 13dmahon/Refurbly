  ...
  if (currentView === 'admin') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        <div
          className="bg-white border-b border-charcoal-200 px-6 py-4 flex justify-between items-center"
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-charcoal-900">Admin Panel</h1>
          </div>
          <ProfileDropdown
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-charcoal-900">Unlock Premium</h1>
          </div>
          <ProfileDropdown
            onLogout={handleLogout}
            onAdminClick={() => setCurrentView('admin')}
        ...
        <div className="p-6 pt-8 max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl border border-charcoal-200 p-8">
            ...
            <div className="mt-8 pt-8 border-t border-charcoal-200">
              <h3 className="font-bold text-charcoal-900 mb-4 text-center">
                ✨ What's Included:
              </h3>
              <div className="grid gap-3 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-charcoal-900">Detailed Room Breakdowns</div>
                    <div className="text-charcoal-600">See exact costs for kitchen, bathrooms, flooring, etc.</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-sage-600 font-bold text-lg">✓</span>
                  <div>
                    <div className="font-semibold text-charcoal-900">Labour Hours & Rates</div>
                    <div className="text-charcoal-600">Understand how many hours each job takes</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-sage-600 font-bold text-lg">✓</span>
                  <div>
                    <div className="font-semibold text-charcoal-900">Material Cost Evidence</div>
                    <div className="text-charcoal-600">Links to Checkatrade & Knight Frank sources</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-sage-600 font-bold text-lg">✓</span>
                  <div>
                    <div className="font-semibold text-charcoal-900">Edit & Adjust Quotes</div>
                    <div className="text-charcoal-600">Customize costs and add custom items</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-sage-600 font-bold text-lg">✓</span>
                  <div>
                    <div className="font-semibold text-charcoal-900">Save Up to 10 Quotes</div>
                    <div className="text-charcoal-600">Compare multiple properties</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-charcoal-900">Terms & Conditions</h1>
          </div>
        </div>
        <div className="max-w-4xl mx-auto">
          <TermsAndConditions onClose={null} />
        </div>
      </div>
    );
  }
    ...
    <>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <img src="/logo.svg" alt="Refurbly" className="h-8 w-auto" />
                <h1 className="text-xl font-bold text-charcoal-900">Refurbly</h1>
              </div>
            </div>
            ...
            {!user && (
              <button
                ...
                className="px-4 py-2 text-navy-700 font-semibold hover:bg-navy-50 rounded-lg transition"
              >
                Sign In
              </button>
            )}
      ...
      {currentView === 'dashboard' && (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          >
            <div>
              <h1 className="text-xl font-bold text-charcoal-900">My Saved Quotes</h1>
              <p className="text-sm text-charcoal-600">
                {savedQuotes.length} / {maxQuotes} quotes used
                {isPremium && (
                  <span className="ml-2 text-sage-600 font-semibold">✓ Premium</span>
                )}
              </p>
            </div>
            <ProfileDropdown
          ...
          <div className="p-6 pt-5 sm:pt-7">
            <div className="max-w-6xl mx-auto">
              {!isPremium && savedQuotes.length >= 5 && (
                <div className="bg-gradient-to-br from-navy-700 to-navy-800 rounded-2xl p-8 mb-6 text-white shadow-xl">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="bg-white rounded-xl p-6 text-center min-w-[250px]">
                      <div className="text-3xl font-bold text-charcoal-900 mb-2">£9.99</div>
                      <div className="text-sm text-charcoal-600 mb-4">One-time payment</div>
                      {Capacitor.getPlatform() === 'ios' ? (
                        <button
                          onClick={() => setCurrentView('unlock-premium')}
                          className="w-full bg-navy-700 text-white py-2 px-4 rounded-lg font-semibold hover:bg-navy-800 transition"
                        >
                          🔓 Unlock Premium
                        </button>
                      ) : (
              ...
              <div className="mb-6">
                <button
                  ...
                  className="bg-navy-700 text-white px-6 py-3 rounded-lg font-semibold hover:bg-navy-800 transition"
                >
                  + Create New Quote
                </button>
              </div>
              ...
              {loadingQuotes ? (
                <div className="text-center py-12">
                  <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-navy-700 mx-auto"></div>
                  <p className="mt-4 text-charcoal-600">Loading quotes...</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                  ...
                  {isPremium ? (
                    <div className="mt-8 bg-gradient-to-r from-sage-50 to-sage-100 border-2 border-sage-200 rounded-xl p-6 max-w-2xl mx-auto">
